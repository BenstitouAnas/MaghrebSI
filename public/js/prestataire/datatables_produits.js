...
$(function() {
    ...
    tablef = $('.datatable-basic2').DataTable({
        ...
        columns: [
            ...
            { data: 'typeProduit', name: 'typeProduit' },
        ...
        "drawCallback": function(settings) {
            ...
            api.column(0, { page: 'current' }).data().each(function(group, i) {
                if (last !== group) {
                    $(rows).eq(i).before(
                        '<tr class="bg-grey-300"><td colspan="7" style="text-shadow:0px 0px 4px rgba(0, 0, 0, 0.56); color:#fff; font-weight:500"><i></i>' + group + '</td></tr>'
                    );
