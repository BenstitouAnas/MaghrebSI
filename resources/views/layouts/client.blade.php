					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li><a href="{{ url('/Clients') }}"><i class="fa fa-home"></i> <span>Acceuil</span></a></li>

                                <li>
									<a href="{{ url('/Clients/Commandes') }}"><i class="fa fa-shopping-cart"></i> <span class="nav-label">Commandes</span></a>
								</li>

                                <li>
									<a href="#"><i class="fa fa-ticket"></i> <span class="nav-label">Tickets </span><span class="fa arrow"></span></a>
									<ul class="nav nav-second-level collapse">
										<li><a href="{{ url('/Clients/Tickets') }}">Tickets</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header" style="margin: 5px 2px 5px 2px;">
					...
					<div class="breadcrumb-line breadcrumb-line-component">
						<ul class="breadcrumb">
							<li><a href="{{ url('/Clients') }}"><i class="icon-home2 position-left"></i> Home</a></li>
