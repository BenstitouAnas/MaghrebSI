					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li><a href="{{ url('/Prestataires') }}"><i class="fa fa-home"></i> <span>Acceuil</span></a></li>
								...
								<li>
									<a href=""><i class="fa fa-sitemap"></i> <span>Clients</span></a>
								</li>
                                ...
                                <li>
									<a href="#"><i class="fa fa-sitemap"></i> <span class="nav-label">Utilisateurs </span><span class="fa arrow"></span></a>
									<ul class="nav nav-second-level collapse">
